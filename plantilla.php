...
<script src="https://cdn.jsdelivr.net/npm/qz-tray@2.1.0/qz-tray.js"></script>
  ...
  <script type="text/javascript" src="../FOX-CONTROL/extensiones/impresora/qz-tray.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jsrsasign/10.5.23/jsrsasign-all-min.js"></script>
                ...
                echo '<div class="wrapper">';
                  ...
                  if(isset($_GET["ruta"])){
                    ...
                    if(
                      ...
                      $_GET["ruta"] == "cxc" ||
                      $_GET["ruta"] == "ventas" ||
                      $_GET["ruta"] == "ventas-globales" ||
                      $_GET["ruta"] == "ver-declaracion" ||
                      $_GET["ruta"] == "compras" ||
                      ...
                      include "modulos/facturacion.php";
