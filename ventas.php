...
<div class="main-content content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">        
      <button class="btn btn-warning" data-toggle="modal" data-target="#modalCrearFolio" hidden>Generar folios</button>
        <?php
        ...
        <button class="btn btn-warning"  data-toggle="modal" data-target="#modalEscogerFechaFinal" onclick="generarDeclaracionFinal()">Transmitir</button>
...
<!--=====================================
MODAL SELECCIONAR FECHA PARA DECLARACION FINAL
======================================-->

<div id="modalEscogerFechaFinal" class="modal" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:grey; color:white">
          <h4 class="modal-title">Seleccionar mes y año de declaración</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
                  ...
                  <input type="month" class="form-control" id="nuevaFechaDeclaracion" name="nuevaFechaDeclaracion" required>
                  <input type="text" name="tipo" value="Final" hidden>
                  <input type="text" name="facturas" id="facturas" hidden>
                  <input type="text" name="pago_cuentas" value="<?php echo round($pagoAcuentasF, 2) ?>" hidden>
                  <input type="text" name="url" value="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" hidden>
...
<!--=====================================
MODAL SELECCIONAR FECHA PARA DECLARACION CONTRIBUYENTE
======================================-->

<div id="modalEscogerFechaContribuyente" class="modal" role="dialog">
    ...
    <div class="modal-content">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
                  ...
                  <input type="month" class="form-control" id="nuevaFechaDeclaracion" name="nuevaFechaDeclaracion" required>
                  <input type="text" name="tipo" value="Contribuyente" hidden>
                  <input type="text" name="facturas" id="facturasC" hidden>
                  <input type="text" name="pago_cuentas" value="<?php echo round($pagoAcuentas, 2) ?>" hidden>
                  <input type="text" name="url" value="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" hidden>
            </div>
          </div>  
        ...
        <?php
          ...
          $declaraciones = new ControladorDeclaraciones();
          $declaraciones -> ctrCrearDeclaracion();
