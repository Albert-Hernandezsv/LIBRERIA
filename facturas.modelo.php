...
class ModeloFacturas{
	...
	static public function mdlMostrarCortesOptimizados($tabla, $item, $valor, $orden){
	...
	static public function mdlIngresarCorte($tabla, $datos) {
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(ids_facturas, id_facturador, fecha) VALUES (:ids_facturas, :id_facturador, :fecha)");
	...
	static public function mdlIngresarAbono($tabla, $datos) {
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_factura, forma_abono, fecha_abono, gestion_abono, banco, monto, dinero_cliente) VALUES (:id_factura, :forma_abono, :fecha_abono, :gestion_abono, :banco, :monto, :dinero_cliente)");
		...
		$stmt->bindParam(":dinero_cliente", $datos["dinero_cliente"], PDO::PARAM_STR);
